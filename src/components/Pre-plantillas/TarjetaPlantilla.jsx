            ...
            <div className="mb-4">
                ...
                <> 
                    ...
                    <div className="ml-4 mb-2" style={{ height:"7rem"}}>
                        {(props.tipo === "A")? 
                        <img className="card-img" src={PlantillaImgA} alt="Plantilla_demo" style={{width:"8rem"}}/>  
                        :''}
                        {(props.tipo === "B")? 
                        <img className="card-img" src={PlantillaImgB} alt="Plantilla_demo" style={{width:"8rem"}}/>  
                        :''}
                        {(props.tipo === "C")? 
                        <img className="card-img" src={PlantillaImgC} alt="Plantilla_demo" style={{width:"8rem"}}/>  
                        :''}
                    ...
                    <div className="ml-4">
                        <div className="btn-group btn-group-sm mb-2 ml-4" role="group" aria-label="Basic example">
                        <button type="button" class="btn btn-warning text-dark btn-sm mr-1" title="Editar" onClick={() => props.BottonEditar(props.plantilla)}><FontAwesomeIcon  icon={faEdit}/></button>
                        <button type="button" class="btn btn-danger text-dark btn-sm text-dark" title="Eliminar" onClick={() => props.EliminarPlantilla(props.plantilla._id)}><FontAwesomeIcon  icon={faTrash}/></button>
                        </div>
                    </div>  
                </>}
