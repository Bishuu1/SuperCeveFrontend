...
const PlantillaA = (props) => {
  return (
    <Fragment>
      <div
        className="PlantillaA card border-dark p-4 "
        style={{
          width: '400px',
          height: '500px',
          overflowY: 'auto',
        ...
        {props.plantilla.Color === 'azul' ? (
          <div className="">
            <div className="row pl-3 pr-3">
              ...
              <div
                className="col-md-6 pt-2 card border-primary "
            ...
            <div className="PlantillaBody">
              {props?.entradas.filter(
                (entrada) => entrada.TipoEntrada === 'Publicacion'
              ).length != 0 ? (
        ...
        {props.plantilla.Color === 'rojo' ? (
          <div className="">
            <div className="row pl-3 pr-3">
              ...
              <div
                className="col-md-6 pt-2 card border-danger"
                style={{ maxWidth: '173px' }}
              >
                <DatosAcademico academico={props.academico} />
              </div>
        ...
        {props.plantilla.Color === 'negro' ? (
          <div className="">
            <div className="row pl-3 pr-3">
              ...
              <div
                className="col-md-6 pt-2 card border-dark"
                style={{ maxWidth: '173px' }}
              >
                <DatosAcademico academico={props.academico} />
              </div>
