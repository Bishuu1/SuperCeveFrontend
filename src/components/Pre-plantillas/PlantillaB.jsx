...
const PlantillaB = (props) => {
    return ( 
    <Fragment>
    <div className="PlantillaB card border-dark " style={{width:"400px",height:"500px", fontFamily:props.plantilla.Fuente}}>
       <div className="row">
            <div className="" style={{width:"140px"}}>
                {(props.plantilla.Color == "azul")?  
                <div className="bg-primary text-white ml-3" style={{width:"140px",minHeight:"496px"}}>                  
                    <PlantillaBDatos academico={props.academico} plantilla={props.plantilla}/>
                </div>: ''    
                }
                {(props.plantilla.Color == "rojo")?  
                <div className="bg-danger text-white ml-3" style={{width:"140px",minHeight:"496px"}}>                  
                    <PlantillaBDatos academico={props.academico} plantilla={props.plantilla}/>
                </div>: ''    
                }
                {(props.plantilla.Color == "negro")?  
                <div className="bg-secondary text-white ml-3" style={{width:"140px",minHeight:"496px"}}>                  
                    <PlantillaBDatos academico={props.academico} plantilla={props.plantilla}/>
                </div>: ''    
                }
            </div>
