...
const ColumnaPlantillas = (props) => {
  return (
    <Fragment>
      <div
        className="col-md-3 p-3 bg-dark card border-secondary"
      ...
      >
        ...
        >
          <div className="row" style={{ maxWidth: '340px' }}>
            <TarjetaPlantilla
              ChangeTipoPlantilla={props.ChangeTipoPlantilla}
              tipo="A"
              nombre=""
            />
            <TarjetaPlantilla
            ...
            {props.plantillasDB.map((item) => (
              <div key={item._id}>
                <TarjetaPlantilla
                  BottonEditar={props.BottonEditar}
                  ChangeTipoPlantilla={props.ChangeTipoPlantilla}
                  tipo={item.TipoPlantilla}
                  nombre={item.Nombre}
                  plantilla={item}
                  EliminarPlantilla={props.EliminarPlantilla}
                />
              </div>
            ))}
          </div>
