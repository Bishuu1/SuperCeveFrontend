...
const PlantillaC = (props) => {
    ...
    <div className="PlantillaC card border-dark" style={{width:"400px",height:"500px", fontFamily:props.plantilla.Fuente}}>
        {(props.plantilla.Color == "azul")? 
        <>
            <div className="card border-primary mt-2 ml-4 mr-4 pb-2">
            <PlantillaCDatos academico={props.academico} plantilla={props.plantilla}/>
